...
function App() {
  ...
  const handleValue = (e) => {
    if (e.target.classList.contains('icon')) {
      ...
      console.log(`dataset gej yu we?===================>`, e.target.dataset)
      setTitle(newValue)
      setValue(person[newValue])
      console.log(`uunii darah person`, person[newValue])
    }
  }
  return (
    <main>
      ...
      <div className='block'>
        <div className='container'>
          ...
          <div className='values-list'>
            ...
            <button className='icon' data-label='password' data-myname='hi phill anderson' onMouseOver={handleValue}><FaLock /></button>
          </div>
